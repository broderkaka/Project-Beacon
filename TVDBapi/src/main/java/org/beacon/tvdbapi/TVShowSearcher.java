...
public class TVShowSearcher {
	...
	public ArrayList<TVShow> search(String tvShowName) throws XMLStreamException, IOException {
	...
	private TVShow parseTVShow(XMLStreamReader reader) throws XMLStreamException {
	...
	private void parseTag(XMLStreamReader reader, TVShow tvshow) throws XMLStreamException {
